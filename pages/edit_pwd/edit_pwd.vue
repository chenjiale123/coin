		...
		<view class="cj-main">
			<view class="cj-in">
				<form>
					...
					<text>原密码</text>
					<input type="text" value="" v-model="model.password" placeholder="请输入旧密码" class="old" />
					<text>新密码</text>
					<input type="text" value="" v-model="model.new_pass" placeholder="请输入密码" class="new" />
					<text>确认密码</text>
					<input type="text" value="" v-model="model.check_pass" placeholder="请再次输入密码" class="sure" />


					<button v-on:click="doSubmit">确定</button>
				</form>
			</view>
...
import uniRequest from 'uni-request';
	export default {
		...
		methods: {
			...
			doSubmit: function() {
				let _this = this;
				uniRequest.post('/api/user/password', _this.model)
